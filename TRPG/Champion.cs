...
namespace TRPG
{
    using System;
        ...
        internal abstract class Champion : IStatus
        {
            ...
            public Champion(string name, int hp, int mp, int atk, int def, int growthHp, int growthMp, int growthAtk, int growthDef)
            {
                Name = name;
                this.hp = hp;
                this.mp = mp;
            ...
            {
                Console.WriteLine($"{Name}이 기본 공격을 사용합니다. (데미지: {atk})");
            }
